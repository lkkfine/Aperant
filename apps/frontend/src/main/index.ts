...
const possibleEnvPaths = [
  resolve(__dirname, '../../.env'),           // Development (legacy): out/main -> apps/frontend/.env
  resolve(__dirname, '../../apps/frontend/.env'), // Development: build/main -> apps/frontend/.env
...
function getIconPath(): string {
  const resourcesPath = is.dev
    ? (existsSync(join(__dirname, '../../apps/frontend/resources'))
        ? join(__dirname, '../../apps/frontend/resources')
