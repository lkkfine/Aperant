...
def get_specs_dir(project_dir: Path) -> Path:
    ...
    IMPORTANT: Only .aperant/ is considered an "installed" auto-claude.
    ...
    This function also ensures .aperant is added to .gitignore on first use.

    Args:
        project_dir: The project root directory

    Returns:
        Path to the specs directory within .aperant/
    """
    # Initialize .aperant directory and ensure it's in .gitignore
    init_auto_claude_dir(project_dir)

    # Return the specs directory path
    return project_dir / ".aperant" / "specs"
