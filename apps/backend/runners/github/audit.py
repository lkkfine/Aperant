...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".aperant/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .aperant/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".aperant/github/audit")
